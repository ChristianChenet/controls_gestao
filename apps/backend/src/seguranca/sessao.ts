...
export type UsuarioSessao = { id:number; nome:string; email:string; empresaId:number; empresaAtivaId:number; administrador:boolean; superadmin:boolean; permissoes:string[] };
